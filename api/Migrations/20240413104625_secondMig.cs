    ...
    public partial class secondMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(8)", maxLength: 8, nullable: false, collation: "ascii_general_ci"),
                    ...
                    BusType = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusId = table.Column<Guid>(type: "char(8)", nullable: false, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RouteId = table.Column<Guid>(type: "char(8)", nullable: false, collation: "ascii_general_ci"),
                    DepatureDateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ArrivalDateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TotalFare = table.Column<double>(type: "double", nullable: false),
                    BusId = table.Column<Guid>(type: "char(8)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
